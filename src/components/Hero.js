                ...
                <Container>
                    <ColumnLeft>
                        ...
                        <motion.p
                            ...
                            animate='visible'
                            transition={{ duration: 1 }}
                        >Journey to the unknow</motion.p>
                        <Button
                    ...
                    <ColumnRight>
                        ...
                        animate={{ opacity: 1, y: 20, transition:{ duration: 2} }}  
                        />
                        <Image src={PlanetTwo} alt='planet'
                            ...
                            animate={{ opacity: 1, x: 100, transition: { duration: 3 } }}
                        />
                        <Image src={PlanetThree} alt='planet'
                            ...
                            animate={{ opacity: 1, x: -150, transition: { duration: 2 } }}
                        />
                        <Image src={PlanetFour} alt='planet'
                            ...
                            animate={{ opacity: 1, y: 20, transition: { duration: 3 } }}
                        />
                    </ColumnRight>
                </Container>
            </Section>
